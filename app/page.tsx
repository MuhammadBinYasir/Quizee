    ...
    <div className="w-full h-screen bg-white flex flex-col">
      <div className="w-full h-20 flex items-center justify-between px-5">
        ...
        <div className="flex items-center gap-3">
          <Link href="/sign-in" className=" text-sm px-3 py-2 text-primaryColor ">Login</Link>
          <Link href="/sign-up" className="text-sm px-4 py-2 bg-primaryColor rounded-full text-white">Create Account</Link>
        </div>
      </div>
